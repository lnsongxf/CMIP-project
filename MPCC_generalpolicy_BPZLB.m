...
rsp_shock  = [0.9 0.85 0.75 0.6 0.5 ...
              0.4 0.4 0.4 0.4 0.4];
shock_s_bl = 0.7;%[0.7*ones(1,8) 0.8 .9];
shock_T    = 0                              ;  
...
gamma = 1/2     ; % agent's risk aversion
...
s2    = 90    ; % volatility - high intensity technology
...
r_m_aux = 0.01;   % this will be adjusted 
...
plot(Periods(1:t_plotmax), rb_t(1:t_plotmax)*100,'--o','LineWidth',4,'Color',color1_shock); 
...
% Fed Policy
figure(cc)
plot(Periods(1:t_plotmax) , TE_t(Periods(1:t_plotmax))./Y_t(Periods(1:t_plotmax))*100,'LineWidth',4,'Color',color1_ss); hold on;
plot(Periods(1:t_plotmax) , TE_ss/Y_ss*100+0*TE_t(Periods(1:t_plotmax)),'k:','LineWidth',1); grid on;
...
figure(cc)
plot(Periods(1:t_plotmax) , RT_t(Periods(1:t_plotmax))./Y_t(Periods(1:t_plotmax))*100,'LineWidth',4,'Color',color1_ss); hold on;
plot(Periods(1:t_plotmax) , RT_ss/Y_ss*100+0*RT_t(Periods(1:t_plotmax)),'k:','LineWidth',1); grid on;
[yout]=get(gca,'ylim');
line([T_pre+1 T_pre+1],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
line([T_post T_post],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
h=patch([T_pre+1 T_post T_post T_pre+1],[yout(1) yout(1) yout(2) yout(2)],[0.9 0.9 0.9]); alpha(h,0.2);
...
figure(cc);
plot(Periods(1:t_plotmax), (B_t(1:t_plotmax)/B_ss-1)*100,'LineWidth',4,'Color',color1_ss); hold on; 
plot(Periods(1:t_plotmax), (D_t(1:t_plotmax)/D_ss-1)*100,'--o','LineWidth',4,'Color',color1_shock);  grid on;
axis tight; [yout]=get(gca,'ylim');
line([T_pre+1 T_pre+1],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
line([T_post T_post],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
h=patch([T_pre+1 T_post T_post T_pre+1],[yout(1) yout(1) yout(2) yout(2)],[0.9 0.9 0.9]); alpha(h,0.2);
...
hold on;
scatter3(Periods(1:t_plotmax),s_vec(1)*ones(1,t_plotmax),f_t(1,1:t_plotmax)); 
axis tight;
