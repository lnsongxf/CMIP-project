...
shock_T=-4                       ; % Rate of money growth do to transfers 
T_t(1:T)=0                          ;
T_t(T_pre+1)=shock_T                ; 
if T_post-T_pre>2
...
ftitle=title('Real Borrowing/Lending Rates','interpreter','latex'); grid on;
axis tight;
[yout]=get(gca,'ylim');
...
label_x('t'); label_y('$\%$');
ftitle=title('$\mathcal{E}_{t}/Y_{t}$ deviation from $\mathcal{E}_{ss}/Y_{ss}$','interpreter','latex'); grid on;
[yout]=get(gca,'ylim');
line([T_pre+1 T_pre+1],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
line([T_post T_post],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
h=patch([T_pre+1 T_post T_post T_pre+1],[yout(1) yout(1) yout(2) yout(2)],[0.9 0.9 0.9]);
...
label_x('t'); label_y('$\%$');
ftitle=title('$T_{t}/Y_{t}$ deviation from $T_{ss}/Y_{ss}$','interpreter','latex'); grid on;
[yout]=get(gca,'ylim');
line([T_pre+1 T_pre+1],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
line([T_post T_post],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
h=patch([T_pre+1 T_post T_post T_pre+1],[yout(1) yout(1) yout(2) yout(2)],[0.9 0.9 0.9]);
...
label_x('t'); label_y('$\%$');
ftitle=title('$Y_{t}$ deviation from $Y_{ss}$','interpreter','latex'); grid on;
axis tight;
[yout]=get(gca,'ylim'); 
...
label_x('t'); label_y('$\%$');
ftitle=title('$B_{t},A_{t}$ deviation from $B_{ss},A_{ss}$','interpreter','latex'); grid on;
axis tight;
[yout]=get(gca,'ylim');
line([T_pre+1 T_pre+1],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
line([T_post T_post],[yout(1) yout(2)],'Color','k','LineWidth',2,'LineStyle','--');
...
label_x('t'); label_y('$\%$');
ftitle=title('Agents at the constraint','interpreter','latex'); grid on;
axis tight;
set( gca                       , ...
     'FontSize'   , 25 , ...
     'FontName'   , 'Helvetica' );
...
axis tight;
title('Distribution of Wealth and Time');
if printit==1
    imprime(['fig' nameplot num2str(cc)]);
    imprpdf(['fig' nameplot num2str(cc)]);
end
